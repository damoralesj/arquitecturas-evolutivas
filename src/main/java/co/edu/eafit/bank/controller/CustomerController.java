...
public class CustomerController {
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<CustomerDTO> detele(@PathVariable("id") Integer id) throws Exception {
	...
	public ResponseEntity<List<CustomerDTO>> findAll(){
		...
		List<CustomerDTO> customerDTOs = customerMapper.customerToCustomersDTOs(customers);
